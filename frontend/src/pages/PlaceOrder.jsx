  ...
  return (
    ...
    >
      ...
      <div className='flex flex-col gap-4 w-full sm:max-w-[480px]'>
        ...
        {/* Zip / Country */}
        <div className='flex gap-3'>
          <input required type='number' name='zipcode' value={formData.zipcode} onChange={onChangeHandler} className='border border-gray-300 rounded py-1.5 px-3.5 w-full' placeholder='Zip Code' />
        ...
        {/* Phone */}
        <input required type='tel' name='phone' value={formData.phone} onChange={onChangeHandler} className='border border-gray-300 rounded py-1.5 px-3.5 w-full' placeholder='Phone Number' />
      ...
      <div className='mt-8'>
        ...
        {/* Cart Total */}
        <div className='min-h-8 min-w-80'>
          <CartTotal />
        </div>
