       ...
       <div className='flex gap-12 sm:gap-12 flex-col sm:flex-row'>
        ...
        <div className='flex-1'>
          ...
          <div className='flex items-center gap-1 mt-2'>
           ...
           <div className='flex flex-col gap-4 my-8'>
             ...
             <div className='flex gap-2'>
              {productData.sizes.map((item, index) => (
               <button className={`w-8 h-8 border bg-gray-100 flex items-center justify-center cursor-pointer 
               ${item === size ? 'border-orange-500' : ''} `} key={index} onClick={() => setSize(item)}>
                {item}
               </button>
              ))}
            </div>
           ...
           <button className='bg-black text-white py-3 px-8 text-sm active:bg-gray-700 cursor-pointer' onClick={() => addToCart(productData._id, size)}>
            ADD TO CART
